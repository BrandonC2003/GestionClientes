    ...
    <body>
        <nav class="navbar bg-dark navbar-expand-lg" dada-bs-theme="dark">
            <div class="container-fluid">
                <a class="navbar-brand text-white" href="${pageContext.request.contextPath}/SvClientes?accion=listar">Usuarios</a>
        ...
        <article class="container mt-5">
            <div class="card">
                <div class="card-header justify-content-between d-flex">
                    ...
                    <a class="btn btn-success" href="${pageContext.request.contextPath}/SvProductos?accion=agregar">Agregar Productos</a>
                </div>
                <div class="card-body">
